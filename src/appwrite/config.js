...
export class Service{
    ...
    async createPost({title, slug, content, featuredImage, status, userId}) {
        try {
            ...
            console.log("Appwrite servie :: createPsot :: error", error);
        }
    }
    ...
    async uploadFile(file) {
        try {
            ...
            console.log("Appwrite servie :: updateFile :: error", error);
            return false
        }
    }
    ...
    //iska response fast hai to async mein dalne ki need nhi hai itni direct use kr lenge
